...
public class ClassRoll {
    ...
    public static void main(String[] args) {
        ...
        // Collections.sort().
        Comparator<Student> reverseOrderBySection = new CompareStudentsBySection();
        Collections.sort(roll, Collections.reverseOrder(reverseOrderBySection));
    ...
    public static class CompareStudentsBySection implements Comparator<Student> {
        ...
        public int compare(Student s1, Student s2) {
            int compSection = Integer.compare(s1.getSection(), s2.getSection());
            return compSection;
