...
public class Student implements Comparable<Student> {
    ...
    public int compareTo(Student s) {
        int compLastName = this.lname.compareTo(s.getLastName()); 
        int compFirstName = this.fname.compareTo(s.getFirstName());
        int compSection = Integer.compare(this.section, s.getSection());
